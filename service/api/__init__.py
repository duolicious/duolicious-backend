...
def get_ttl_hash(seconds: int = 10) -> Any:
...
def post_sign_in_with_google(req: t.PostSignInWithGoogle) -> Any:
...
def post_sign_in_with_apple(req: t.PostSignInWithApple) -> Any:
    scope = "social_sign_in"
...
def post_auth_apple_callback() -> Any:
...
def post_sign_out(s: t.SessionInfo) -> Any:
...
def get_search_locations(_: Any) -> Any:
...
def delete_onboardee_info(req: t.DeleteOnboardeeInfo, s: t.SessionInfo) -> Any:
...
@aget('/next-questions')
def get_next_questions(s: t.SessionInfo) -> Any:
...
def get_public_next_questions() -> Any:
...
@aget('/search')
def get_search(s: t.SessionInfo) -> Any:
...
@aget('/me')
def get_me_by_session(s: t.SessionInfo) -> Any:
    return person.get_me(person_id_as_int=s.person_id)

@get('/me/<person_id>')
def get_me_by_id(person_id: str) -> Any:
...
def post_unskip(s: t.SessionInfo, prospect_person_id: int) -> Any:
    return person.post_unskip(s, prospect_person_id)

@apost('/unskip/by-uuid/<prospect_uuid>')
def post_unskip_by_uuid(s: t.SessionInfo, prospect_uuid: str) -> Any:
...
def get_compare_answers(s: t.SessionInfo, prospect_person_id: int) -> Any:
...
@adelete('/account')
def delete_account(s: t.SessionInfo) -> Any:
    return person.delete_or_ban_account(s=s)

@apost('/deactivate')
def post_deactivate(s: t.SessionInfo) -> Any:
...
def delete_profile_info(req: t.DeleteProfileInfo, s: t.SessionInfo) -> Any:
...
@aget('/search-filters')
def get_search_filers(s: t.SessionInfo) -> Any:
...
def get_search_filter_questions(s: t.SessionInfo) -> Any:
...
def post_leave_club(req: t.PostLeaveClub, s: t.SessionInfo) -> Any:
    return person.post_leave_club(req, s)

@get('/update-notifications')
def get_update_notifications() -> Any:
...
@aget('/feed')
def get_feed(s: t.SessionInfo) -> Any:
...
@apost('/verify')
def post_verify(s: t.SessionInfo) -> Any:
    limit = "8 per day"
    scope = "verify"
...
def post_dismiss_donation(s: t.SessionInfo) -> Any:
...
def post_mark_visitors_checked(req: t.PostMarkVisitorsChecked, s: t.SessionInfo) -> Any:
