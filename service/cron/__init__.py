...
from backfill.mam_message_body import backfill_mam_message_body_forever
import asyncio
...
async def main():
    await asyncio.gather(
        ...
        # One-off; gated behind DUO_CRON_MAM_MESSAGE_BACKFILL_ENABLED
        backfill_mam_message_body_forever(),
