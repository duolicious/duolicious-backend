...
class TestEmailTemplate(unittest.TestCase):
    ...
    def test_stuff(self):
        e1 = emailtemplate(has_intro=True, has_chat=True)
        e2 = emailtemplate(has_intro=True, has_chat=False)
        e3 = emailtemplate(has_intro=False, has_chat=True)
        e4 = emailtemplate(has_intro=False, has_chat=False)
