...
-- Step 1: Calculate the popularity of each club
...
-- Step 2: Create a CTE with row numbers based on club popularity
...
-- Step 3: Delete rows where the row number is greater than 25
