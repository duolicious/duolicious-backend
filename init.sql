----------------------------------------------------------------------------------- EXTENSIONS---------------------------------------------------------------------------------N-CREATE EXTENSION IF NOT EXISTS pg_trgm;-CREATE EXTENSION IF NOT EXISTS plpython3u;-CREATE EXTENSION IF NOT EXISTS postgis;-CREATE EXTENSION IF NOT EXISTS vector;
